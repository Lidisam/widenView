...
use Prettus\Repository\Eloquent\BaseRepository;  //引入eloquent仓库
use Prettus\Repository\Criteria\RequestCriteria;
use App\Repositories\AdminUserRepository;  //涌入User接口
use App\Models\AdminUser;     //引入AdminUser模型
...
class AdminUserRepositoryEloquent extends BaseRepository implements AdminUserRepository
{
    ...
    {
        $this->pushCriteria(app(RequestCriteria::class)); //这个RequestCriteria怎么启动
    }
